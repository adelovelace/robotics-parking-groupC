...
class ParkingEstimator:
    ...
    The estimator intentionally stays simple: it computes the convex hull of observed
    object boundaries, selects safe empty points inside that hull, keeps the largest
    empty-space cluster, and returns its minimum rotated rectangle.
    """

    def __init__(self, safety_margin: float = 0.16, min_area: float = 0.05):
